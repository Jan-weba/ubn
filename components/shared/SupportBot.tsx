                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label htmlFor="support-name" className="block text-sm font-medium text-gray-700 mb-1">
                      {t('supportBot.fullName')}
                    </label>
                    <input
                      type="text" id="support-name" name="name" value={formData.name}
                  ...
                  <div>
                    <label htmlFor="support-email" className="block text-sm font-medium text-gray-700 mb-1">
                      {t('supportBot.emailAddress')}
                    </label>
                    <input
                      type="email" id="support-email" name="email" value={formData.email}
                      onChange={handleChange} required
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent outline-none transition-all"
                  ...
                  <div>
                    <label htmlFor="support-issue" className="block text-sm font-medium text-gray-700 mb-1">
                      {t('supportBot.describeIssue')}
                    </label>
                    <textarea
                      id="support-issue" name="issue" value={formData.issue}
